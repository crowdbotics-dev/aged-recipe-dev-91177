"""
Django settings for aged_recipe_dev_91177 project.
...
ROOT_URLCONF = 'aged_recipe_dev_91177.urls'
...
WSGI_APPLICATION = 'aged_recipe_dev_91177.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_recipe_dev_91177 API",
    "DESCRIPTION": "API documentation for aged_recipe_dev_91177 App",
    "VERSION": "v1",
}
